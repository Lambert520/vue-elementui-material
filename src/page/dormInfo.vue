      ...
      <div class="add">
        <el-form ref="form" :model="addDormitory" label-width="80px" :rules="rules">
          ...
          <el-form-item label="学号">
            <el-input v-model="addDormitory.s_no" placeholder="请输入数字"></el-input>
          </el-form-item>
          <el-form-item label="姓名">
            <el-input v-model="addDormitory.s_name"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    addDormitoryI() {
      if(this.addDormitory.s_name){
         let _this = this;
      this.$axios
        .post("/dormitory", {
          d_no:_this.addDormitory.d_no,
          s_no: _this.addDormitory.s_no,
          s_name: _this.addDormitory.s_name,
          is_dorm_header: _this.addDormitory.is_dorm_header,
