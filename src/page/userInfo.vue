      ...
      <div class="add">
        <el-form ref="form" :model="addUser" label-width="80px" :rules="rules">
          <el-form-item label="姓名">
            <el-input v-model="addUser.u_name"></el-input>
          </el-form-item>
          <el-form-item label="账号">
            <el-input v-model="addUser.u_no" placeholder="请输入数字"></el-input>
          </el-form-item>
      ...
      <div class="change">
        <el-form ref="form" :model="changeList" label-width="80px">
          ...
          <!-- <el-form-item label="部门">
            <el-input v-model="addUser.deptName"></el-input>
